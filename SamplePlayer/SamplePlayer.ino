...
int button0_patter[] = {1,1,0,0,0,1,1,0};
int button0_patter_pos=0;
int button0_toggle=0;
elapsedMillis button0_elapse;

int button1_patter[] = {0,1,1,0,1,1,0,1};
int button1_patter_pos=0;
int button1_toggle=0;
elapsedMillis button1_elapse;

void setup() {
  Serial.begin(9600);
  //set up the button pattern pos
  button0_patter_pos=0;
  button1_patter_pos=0;
...
void loop() {
  ...
  if (button0.fallingEdge()) {
    button0_toggle=!button0_toggle;
    button0_elapse=0;
  }
  //Serial.println(button1_elapse);
  if(button0_toggle==1){
    if (button0_elapse > 250){
      if(button0_patter[button0_patter_pos]==1){
        sound0.play(AudioSampleSnare);
      }
      button0_patter_pos=button0_patter_pos+1;
      if(button0_patter_pos>7){button0_patter_pos=0;}
      button0_elapse=0;
    } 
  }
  ...
  //Serial.println(button1_elapse);
  if(button1_toggle==1){
    if (button1_elapse > 250){
      if(button1_patter[button1_patter_pos]==1){
        sound1.play(AudioSampleTomtom);
      }
      button1_patter_pos=button1_patter_pos+1;
      if(button1_patter_pos>7){button1_patter_pos=0;}
      button1_elapse=0;
    } 
  }
